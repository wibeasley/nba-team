...
read_chunk("./analysis/shooting-1/shooting-1.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
### Notes 
1. The current report covers `r dplyr::n_distinct(ds$team_id)` teams.
